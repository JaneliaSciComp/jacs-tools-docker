# ****************************************************************************
# Resource name:  JFRC::Utils::SAGE::fly_olympiad_bowl_manual_pf
...
JFRC::Utils::SAGE::fly_olympiad_bowl_manual_pf : fly_olympiad_bowl_manual_pf functions

=head1 SYNOPSIS

use JFRC::Utils::SAGE::fly_olympiad_bowl_manual_pf
...
package JFRC::Utils::SAGE::fly_olympiad_bowl_manual_pf;
...
sub transform
{
  ...
  $row->{notes_curation} .= ' ' . $row->{diagnostic_fields}
    if ($row->{diagnostic_fields});
...
You can find documentation for this module with the perldoc command.
  ...
  perldoc JFRC::Utils::SAGE::fly_olympiad_bowl_manual_pf
