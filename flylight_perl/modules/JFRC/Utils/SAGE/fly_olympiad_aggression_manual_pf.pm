# ****************************************************************************
# Resource name:  JFRC::Utils::SAGE::fly_olympiad_aggression_manual_pf
# Written by:     Rob Svirskas
# Revision level: 0.1
# Date released:  2010-xx-xx
...
# ----------------------------------------------------------------------------
#     0.1     Rob Svirskas      10-xx-xx  Initial version
# ****************************************************************************
...
JFRC::Utils::SAGE::fly_olympiad_aggression_manual_pf : fly_olympiad_aggression_manual_pf functions

=head1 SYNOPSIS

use JFRC::Utils::SAGE::fly_olympiad_aggression_manual_pf
...
package JFRC::Utils::SAGE::fly_olympiad_aggression_manual_pf;
...
=head2 transform
 ...
 Title:       transform
 Usage:       &transform(\%row);
 Description: Set a dummy line name
...
# Aggression enters data without resetting the manual_pf flag
  if (!length($row->{manual_pf})) {
    $main::EARLY_EXIT = 1;
    return(0);
  }
...
You can find documentation for this module with the perldoc command.
  ...
  perldoc JFRC::Utils::SAGE::fly_olympiad_aggression_manual_pf
