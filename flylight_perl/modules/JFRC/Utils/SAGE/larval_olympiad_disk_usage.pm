# ****************************************************************************
# Resource name:  JFRC::Utils::SAGE::larval_olympiad_disk_usage
...
JFRC::Utils::SAGE::larval_olympiad_disk_usage : larval_olympiad_curation

=head1 SYNOPSIS

use JFRC::Utils::SAGE::larval_olympiad_disk_usage
...
package JFRC::Utils::SAGE::larval_olympiad_disk_usage;
...
{
  my($l,$e,$row) = @_;
  $main::BASE_CV = 'larval_olympiad'; #$row->{cv};
...
You can find documentation for this module with the perldoc command.
  ...
  perldoc JFRC::Utils::SAGE::larval_olympiad_disk_usage
