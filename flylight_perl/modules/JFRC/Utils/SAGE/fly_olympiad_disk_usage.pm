# ****************************************************************************
# Resource name:  JFRC::Utils::SAGE::fly_olympiad_disk_usage
...
JFRC::Utils::SAGE::fly_olympiad_disk_usage : fly_olympiad_curation

=head1 SYNOPSIS

use JFRC::Utils::SAGE::fly_olympiad_disk_usage
...
package JFRC::Utils::SAGE::fly_olympiad_disk_usage;
...
{
  my($l,$row) = @_;
  $main::BASE_CV = 'fly_olympiad';
  $main::ES_TYPE = 'disk_usage_detailed';
...
sub observation
{
  ...
  my $s = &main::getSession(cv => $main::BASE_CV,
                            ...
                            name => $main::ES_TYPE);
  if ($s) {
    $main::BASE_CV = 'disk_usage_detailed';
...
You can find documentation for this module with the perldoc command.
  ...
  perldoc JFRC::Utils::SAGE::fly_olympiad_disk_usage
